...
System Components: Depends on the latest `dot-actionFs-v1.0.5-inprogress-KW-wonderAgent.js` module plus Node's `path`.
...
const workspace = path.resolve('./actionfs-test-v1.0.5');
...
async function run() {
  console.log('ActionFs test v1.0.5: verifying every helper in', workspace);
  try {
