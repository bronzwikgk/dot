# Combined Content: shunya_handbook

Source folder: "D:\gk_work\github\dot\ek\shunya_handbook"

## File: flow-story

```text
## Shunya.ek Ecosystem
- creator creates a story. next
- search & define 
    - Story Prerequsite
    - Priority
    - team
- associate understand and fills the MVI
- discover dataset keys
- define dataset values
- design datamap and datatree
- develop datafolder and files.
...
Welcome to team Shunya.ek! At O.1, we believe in minimal rules and meaningful guidelines. Give them a thorough read and follow them during your time with us to maintain a productive and collaborative environment.

Every bit matters, and your adherence to these guidelines contributes to our collective success.
...
- Search Guidelines: [How to search for the right issue, file]
- Working with LLM
- GPT Guidelines: Guidelines for GPT
...
Aesthetics and utility must blend to create meaningful experiences. Consider both aspects of your work and communication.

### Naming Conventions

Use descriptive labels for ease of identification and differentiation. Names should include a reference to the parent category and a unique identifier.

### Appreciation of Beauty

Embrace and contribute to the aesthetic aspects of our work and environment, enriching our professional experience.

### Data-Based Decision Making

Utilize AI for Data Insights: Use AI to gain insights from data, but do not rely on it as the sole decision-maker.

## Workflow and Practices

### Commit Frequency

Make a commit every 2 hours to ensure continuous progress and tracking. [To be Automated]

### Self-Learning and Reporting

Engage in self-learning activities.

Maintain a history of your learning journey.

Submit a Learning Report to document your progress and insights.

### Follow Established Standards

Adherence to standards is crucial for maintaining quality and consistency.
...
## Guidelines - Collate and Consolidate

### Working with LLM

#### Guidelines to Work with LLMS:

- Start From Unknown. Take the Brief and understand more about the brief using LLM's.
- Make a list of prompts and, a list of guidelines for each prompt.
- Request Datasets
- Build Dataset, Table of Content
- Evaluate Always:
  - Ask for a map and Tree
  - Compare both
  - Evaluate Output
- Build Mapping
- Evaluate
...
### GPT Guidelines Generic

#### Adherence & Output Count

Follow guidelines, including token, word, and character counts in outputs.

#### Custom Label & User Query

Start with a custom instruction label and ask users for their names.

### Document

#### Output & Formatting

Generate single block outputs in {OutputSpace}, using markdown with title format name-ver-0-0-1.

#### Version & Structure

Apply semantic versioning starting at 0-0-1; include collapsible sections for structured content.

### List Management

#### Unique IDs & Collapsible Titles

Lists should have unique, indexable IDs with collapsible titles.

### Code Principles

#### SOLID & OOP

Adhere to SOLID and Object-Oriented Programming principles.

#### No ES6 Syntax

Avoid using ES6 Syntax.

#### No forEach

Same goes for forEach and other ES6 methods, use a traditional for loop.

### Glossary & Evaluation

#### Footer Glossary & Evaluation Report

Include a glossary and an evaluation report assessing guideline adherence.
...
### Simplified Guide to Semantic Versioning

Semantic Versioning (SemVer) is a versioning system that helps clarify software changes. It uses Major.Minor.Patch format.

#### Purpose

SemVer ensures clear communication of software updates, making it easy for users and developers to understand the impact of changes.

#### Key Principles

- Major Version (X.y.z): Major changes breaking compatibility.
- Minor Version (x.Y.z): Backward-compatible additions.
- Patch Version (x.y.Z): Bug fixes and tweaks.

#### Version Updates

- Major Update: Significant changes (X.y.z â†’ X+1.0.0).
- Minor Update: New features (x.Y.z â†’ x.Y+1.0).
- Patch Update: Bug fixes (x.y.Z â†’ x.y.Z+1).

#### Decision Table

Quick reference for version updates based on change type.

#### Stable Version

A thoroughly tested and reliable release.
...
- Development: Detailed pre-release versions.
- Staging: Align with production plans.
- Production: Stable SemVer.

#### Practical Quiz on Semantic Versioning

Test your SemVer knowledge with these practical questions:

- [Questions and Answers here]

## Communication Guidelines

### Effective Communication Guidelines: Priorities and Practices

#### Value of Time and Clarity

Recognizing the importance of time and the need for clear communication is fundamental. We promote conversations and discussion over comments here in Linearapp, GitLab, or any other communication app. Avoid unnecessary meetings and discussions when possible.

#### Communication Tools

We utilize Discord and WhatsApp for efficient communication. You'll receive email invitations to join the relevant channels and groups.

#### Logging and Audit

Every communication should be recorded and subject to review, ensuring transparency and accountability.

#### Workplace Culture

Our environment is professional yet enjoyable. We encourage respect and teamwork, rejecting any forms of bullying or heroism.

#### Simplicity in Dialogue

Adopt a 'donkey' approach in conversations. The person initiating the discussion should simplify their language, promoting easy understanding for everyone.

#### Structured Communication Requests

Before any discussion, submit a communication request detailing the agenda, priority, and expected timeframe. This ensures focused and productive interactions.

## Document Guidelines

### Each Page follows the Generic Document Template.

### Each Page to have a Linked TOC.

### Each Item in a list should have a Unique Indexable ID.

### Each Item List should have a total Item.


```

## File: handbook_activity_commit-0-0-0

```text
## handbook activity commit -0-0-0

# Introduction

This handbook outlines the standard operating procedures for our development team regarding code commits. It includes practices for logging in and out at the start and end of each work session, along with making hourly commits.

## Commit Guidelines

### General Commit Practices

- **Frequency:** Make commits at least hourly during active development.
- **Atomic Commits:** Each commit should represent a single logical change or an incremental flow, logged in change log.
- **Testing:** Ensure the code passes all tests before committing.
- **Share:** By deploying it to gitlab pages.

### Login and Logout Commits

#### Purpose

Serve as bookends to a developer's work session.

#### Login Commit

- **Message Format:** "Login: [Date & Time] - Starting session"
- **Action:** Make a login commit when starting your work session.
- **Guideline:** Share a message with the team, it could be motivational, inspirational, or your life learning from yesterday. It can also be your agenda for the day.

#### Logout Commit

- **Message Format:** "Logout: [Date & Time] - Ending session"
- **Action:** Make a logout commit at the end of your work session.
- **Guideline:** Share a message with the team, it could be motivational, inspirational, or your life learning from Today. It can also be a funny summary of the day.

### Hourly Commit Messages

#### Purpose

Document ongoing progress and ensure work is not lost.

- **Message Format:** "Progress: [Date & Time] - Brief description of work done"

### Commit Message Structure

- **Title:** A concise summary of the commit content
- **Body (Optional):** A detailed description of changes made and other relevant information.
- **Format:** "[Type of commit]: [Date & Time] - [Message]"

### Examples

- **Login Commit:** "Login: 2024-02-01 09:00 - Starting session"
- **Hourly Commit:** "Progress: 2024-02-01 10:00 - Implemented user authentication logic"
- **Logout Commit:** "Logout: 2024-02-01 17:00 - Ending session"

## Best Practices

- **Consistency:** Adhere to the commit guidelines and message format.
- **Communication:** Keep the team informed about progress and issues.
- **Documentation:** Document changes well in commit messages and project documentation.

## Conclusion

Following these guidelines enhances collaboration and productivity, ensuring our project history is intelligible and work sessions are effectively documented.

```

## File: handbook_dot_in_action/5d/define

```text
# Scene 2: define

- Define the story or project in Datasets 
- Define Modues & Features
- Define User Stories
- Define Competition,
- Inspiration,
- User & System Flows
...
## File: handbook_dot_in_action/5d/deploy
...
## File: handbook_dot_in_action/5d/design
...
## File: handbook_dot_in_action/5d/develop
...
## File: handbook_dot_in_action/5d/discover

```text
# Scene 1 Discover

## Story Discovery and Initial Scoping

- Identify potential story problem, audience, goals.
- Preliminary research and information gathering.
- Document specific task requirements and objectives.
- Assign the task to the appropriate team member(s).
- Communicate due dates, instructions, and expectations.

### In Short: Discover Dataset
...
- **Market Analysis Report:** Analyze market trends and competition.
- **Competitive Analysis Report:** Identify user needs and pain points.
...
- **Requirement Specification Document:** Conduct user interviews. 
- **User Stories or Use Cases:** Collect and document functional and non-functional requirements.
- **Requirement Prioritization Matrix:** Prioritize requirements.

### Risk Assessment

- **Risk Register:** Identify potential risks and challenges.
- **Risk Mitigation Plan:** Develop a risk mitigation plan.
- **Risk Assessment Report:** Evaluate technical and business risks.

```

## File: handbook_dot_in_action/assest/img/handbook_header_dia.png

_Skipped binary/non-text file._

## File: handbook_dot_in_action/handbook_dia

```text
header bg: public/shunya_handbook/handbook_dot_in_action/assest/img/handbook_header_dia.png

# Handbook: Dots in Action (Dia)

**Audience:** Internal Team at Shunya.ek

## Map

- **Intro to Handbook:** A comprehensive guide to our development process, embodying our commitment to efficiency and innovation.
- **Who We Are:** Makers, builders, designers, coders, engineers united under Shunya.ek, striving to build efficient software tools.
- **What We Do:** We craft templates, apps, frameworks, tools, plugins, utilities, and workflow systems aimed at professionals and amateurs.
- **Where We Do It:** From our offices in Goa & Faridabad, extending to wherever our remote capabilities take us.
- **How We Do It:** By embracing a 5D approach to Discover, Define, Design, Document, Develop, and Deploy.
- **When Do We Do:** Our projects are timeless, focusing on creating lasting solutions in an efficient manner.
- **Glossary:** Key terms and concepts used within Shunya.ek.
- **KnowledgeCenter:** Central hub for sharing insights, learnings, and documentation.
- **Assets:** Resources and tools available for team use.

## Elevator Pitch Dot In Action

**Elevator Pitch:**  
*A fearless adventure is knowing what to do when no oneâ€™s there to tell you what to do.*

## Story Objective

- **Speed Up Processes:** Increase the speed of label changes, activity logs, and merge requests.
- **Achieve Milestones:** Timely completion of project milestones.
- **Workflow Pipeline Guide:** Provide a step-by-step workflow pipeline for Shunya.ek in 5D.
- **Framework Development:** Discover, Define, Design, Document, Develop, and Deploy a framework for the team.
- **Reduce Errors/Rework:** Minimize errors and rework in development processes.

## Story Purpose

- **Peak Efficiency:** Become the most efficient organization globally in software development.
- **Resource Optimization:** Optimize every resource, from bits & bytes to energy bills.
- **Maximize Speed:** Ensure the fastest delivery times without compromising quality.
- **Joyful Work Life:** Foster a joyful and fulfilling work environment in 5D.

### What is 5D?

5D represents a plan of action for an efficient release cycle, involving a collaborative effort between humans and AI through stages of Review, Audit, and Approval.

### 5D Way to Work and Stages of Existence

1. **Discover:** Identify problems and explore the surrounding context.
2. **Define:** Craft a clear solution vision.
3. **Design:** Architect the system to solve the problem.
4. **Develop:** Build the application with precision.
5. **Deploy:** Release the solution to the end-users.

## Stage Pipeline across Status

- **Creation:** Stories are initiated by humans or agents.
- **Population:** MVI (Minimum Viable Information) is filled by the actor.
- **Labeling:** Stories are categorized at {{ Story Inaction }}.
- **Acceptance:** Actor officially begins the story.
- **5D Begins:** Notification to {{ Story Followers }}.
- **Documentation:** Creation of Story Branch, Folder, File {{ Utility }}, and TOC (Table of Content).
- **Review:** Collaborative review with the Author.

## FAQ

- **Who We Are:** A team of professionals passionate about solving complex workflow problems.
- **What We Do:** We create efficient, user-friendly software solutions.
- **How We Do It:** Through a structured 5D process that ensures clarity and efficiency from start to finish.
- **Where We Do It:** Globally, with a strong presence in Goa & Faridabad and an expansive remote network.
- **Why We Do It:** To fill the market gap with simple, integrated, nextGen systems.
- **When Do We Do It:** Our projects are ongoing, with a focus on continuous improvement and innovation.
- **Where Do We Do It Again:** At Shunya.ek, we're not just confined to physical locations but extend our capabilities wherever technology takes us.

## KC

For more in-depth knowledge and resources, refer to our central hub: [https://linear.app/method](https://linear.app/method)

This handbook encapsulates the essence of Shunya.ek's approach to software development, embodying our values, processes, and commitment to excellence.

```

## File: handbook_dot_in_action/handbook_javascript.md

```text


 Please note: there's a newer version of this guide that includes
 ECMAScript 6th Edition features. It lives [here](jsguide.html).
...
- Never use the
 [`const` keyword](https://developer.mozilla.org/en/JavaScript/Reference/Statements/const)
...
`Objects`'
 immutability is more subjective â€” objects should be
...
The `@const` annotation on a variable or property
 ...
 [`const` keyword](https://developer.mozilla.org/en/JavaScript/Reference/Statements/const) (which we do not use due to the
 ...
 * @const
 */
 MyClass.fetchedUrlCache\_ = new goog.structs.Map();
...
1. JavaScript error - first the function returning 42 is called
 with the second function as a parameter, then the number 42 is
 "called" resulting in an error.
2. You will most likely get a 'no such property in undefined'
 error at runtime as it tries to call
 `x[ffVersion, ieVersion][isIE]()`.
3. `die` is always called since the array minus 1 is
...
For that reason, it is best to use `goog.inherits()` from
 [the Closure Library](https://code.google.com/closure/library/) 
...
Current JavaScript engines optimize based on the "shape"
 of an object, [adding a property to an object (including overriding
...
The ability to create closures is perhaps the most useful and often
 ...
 [a good description of how closures work](http://jibbering.com/faq/faq_notes/closures.html).
...
the function closure keeps a reference to `element`,
 ...
 Only for code loaders and REPL (Readâ€“evalâ€“print loop)
...
Let's assume we have a server that returns something like this:
 ...
 "name": "Alice",
 "id": 31502,
 "email": "looking\_glass@example.com"
 }
...
Do not create local aliases of namespaces. Namespaces should only
 be aliased using [goog.scope](#goog-scope).
...
We follow the [C++ formatting
 rules](cppguide.html#Formatting) in spirit, with the following additional clarifications.
...
[`goog.scope`](https://docs.google.com/document/pub?id=1ETFAuh2kaXMVL-vafUYhaWlhl6b5D9TOvboVg7Zl68Y)
 ...
 [the Closure
 Library](https://code.google.com/closure/library/).
...
Except for [array literals,
 object literals](#Array_and_Object_literals), and anonymous functions, all wrapped lines
...
Global variables, functions, and constructors should never be
 ...
 // File 1.
 // AA\_PrivateClass\_ and AA\_init\_ are accessible because they are global
 ...
 * @constructor
 */
 AA\_PrivateClass\_ = function() {
 };

 /** @private */
 function AA\_init\_() {
 return new AA\_PrivateClass\_();
 }
...
Note that these semantics differ from those of C++ and Java, in that
 ...
 /** @constructor */
 AA\_PublicClass = function() {
 /** @private */
 this.privateProp\_ = 2;
 ...
 /** @private */
 AA\_PublicClass.staticPrivateProp\_ = 1;

 /** @protected */
 AA\_PublicClass.staticProtectedProp = 31;

 /** @private */
 AA\_PublicClass.prototype.privateMethod\_ = function() {};

 /** @protected */
 AA\_PublicClass.prototype.protectedMethod = function() {};
 ...
 */
 AA\_PublicClass.prototype.method = function() {
 // Legal accesses of these two properties.
 return this.privateProp\_ + AA\_PublicClass.staticPrivateProp\_;
 };
 ...
 /**
 * @constructor
 * @extends {AA\_PublicClass}
 */
 AA\_SubClass = function() {
 // Legal access of a protected static property.
 AA\_PublicClass.staticProtectedProp = this.method();
 };
 goog.inherits(AA\_SubClass, AA\_PublicClass);

 /**
 * @return {number} The number of ducks we've arranged in a row.
 */
 AA\_SubClass.prototype.method = function() {
...
When documenting a type in JSDoc, be as specific and accurate as
 ...
 [EcmaScript 4 spec](http://wiki.ecmascript.org/doku.php?id=spec:spec).
...
An object in which the keys are strings and the values
 ...
 to that type. The idea is analogous to generics in Java.
  |  |
| Type Union | `{(number|boolean)}`A number or a boolean.
...
`{(number||boolean)}` |
| Nullable type | `{?number}` A number or null.
...
| 
 ...
 number of arguments.
  |  |
| Function [optional arguments](#optional) | `{function(?string=, number=)}`
...
| 
 Function [optional arguments](#optional)
...
| Number | 
 new Number(true)
  | [Number object](#Wrapper_objects_for_primitive_types)  |
| string | 
 'Hello'
 "World"
 String(42)
...
| String | 
 new String('Hello')
 new String(42)
  | [String object](#Wrapper_objects_for_primitive_types)  |
| boolean | 
 true
 false
 Boolean(0)
...
| Boolean | 
 new Boolean(true)
  | [Boolean object](#Wrapper_objects_for_primitive_types)  |
| RegExp | 
 new RegExp('hello')
 /world/g
  |  |
...
| Function | 
 ...
 return x * y;
  ...
  | [Function object](#Wrapper_objects_for_primitive_types)  |
 ...
 * @param {Object=} opt\_value Some value (optional).
 * @constructor
 */
 function MyClass(opt\_value) {
 /**
 * Some value.
 * @type {Object|undefined}
 * @private
 */
 this.myValue\_ = opt\_value;
 }
 ...
 * @param {!Object=} opt\_nonNull Optional (may be undefined), but if present,
 * must not be null!
 * @param {Object=} opt\_mayBeNull Optional (may be undefined), may be null.
 */
 function strangeButTrue(nonNull, mayBeNull, opt\_nonNull, opt\_mayBeNull) {
 // ...
 };
 ...
 * @template T
 */
 goog.bind = function(fn, thisObj, var\_args) {
 ...
 };
...
Use JSDoc
 ...
 We follow the
 [C++ style for comments](cppguide.html#Comments) in spirit.
 


All files, classes, methods and properties should be documented with
 [JSDoc](https://code.google.com/p/jsdoc-toolkit/)
 comments with the appropriate [tags](#JSDoc_Tag_Reference)
 and [types](#JsTypes). Textual descriptions for properties,
...
The JSDoc syntax is based on
 [JavaDoc](https://www.oracle.com/technetwork/java/javase/documentation/index-137868.html). Many tools extract metadata from JSDoc comments to
 ...
 */
 ...
 The [JavaDoc](https://www.oracle.com/technetwork/java/javase/documentation/index-137868.html) style guide is a useful resource on how to write
 well-formed doc comments.
 



 A [copyright notice](copyright.html) and author information are optional.
...
*For example:*
 ...
 /** @const */ var MY\_BEER = 'stout';

 /**
 * My namespace's favorite kind of beer.
 * @const {string}
 */
 mynamespace.MY\_BEER = 'stout';

 /** @const */ MyClass.MY\_BEER = 'stout';
...
When `@const` is applied to a method, it
 ...
 that the method is *finalized* â€”
...
*For example:*
 ...
 /** @define {boolean} */
 var TR\_FLAGS\_ENABLE\_DEBUG = true;

 /**
 * @define {boolean} Whether we know at compile-time that
 * the browser is IE.
 */
 goog.userAgent.ASSUME\_IE = false;
  | 
 ...
 */
 BN\_EditUtil.isTopEditableField = function(node) {
 // ...
 };
  | 
...
which will export the symbols to uncompiled code.
 Code that uses the `@export` annotation must either1. include `//javascript/closure/base.js`, or
2. define both `goog.exportSymbol` and
...
*For example:*
 ...
 The [JSDoc Toolkit docs](https://code.google.com/p/jsdoc-toolkit/wiki/TagLends) have more information on this
 annotation.
  |
| @license or
 @preserve | `@license Description`
*For example:*
 ...
 */
 ...
 [private](#Visibility__private_and_protected_fields_) and final.
  |
| @protected | `@protected`
`@protected {type}`
*For example:*
 ...
 */
 ...
 [protected](#Visibility__private_and_protected_fields_).
 ...
 * discouraged.
 */
 goog.events.Event.prototype.propagationStopped\_ = false;
  | 
 ...
 */
 ...
 [template typename](#Template_types).
  |
| @this | `@this Type
 @this {Type}` 
*For example:*
 ...
 */
 function() {
 return this.getWrappedComponent\_().getElement();
 });
  | 
 ...
 */
 var hexId = hexId;
  | 
 Identifies the [type](#JsTypes) of a variable,
...
*For example:*
 ...
 [JSDoc Toolkit Tag Reference](https://code.google.com/p/jsdoc-toolkit/wiki/TagReference) 
...
## File: handbook_dot_in_action/sos.html
...
<head>
    ...
    <title>Story of a Story ver 0.0.1</title>
    <style>
...
<header>
    ...
    <p>A fearless adventure is knowing what to do when no oneâ€™s there to tell you what to do.</p>
    <div class="menu-btn" onclick="toggleSidebar()">&#9776;</div> <!-- Hamburger button -->
</header>

<div class="sidebar" id="sidebar">
    <h2>Table of Contents</h2>
    <ul>
        <li><a href="#journey">Journey Major Milestones</a></li>
        <li><a href="#lifecycle">Story Lifecycle</a></li>
        <li><a href="#types">Type of Stories</a></li>
        <li><a href="#activity">Story Generic Activity Flow</a></li>
...
<div class="content">
    <section id="journey">
        <h2>Journey Major Milestones</h2>
        <p><strong>Birth - Shunya - InQue:</strong> The inception of an idea.</p>
        <p><strong>Process - Dot - In Development:</strong> The development phase.</p>
        <p><strong>End - Ek - Deployed to Market:</strong> The completion and release phase.</p>
    </section>
    <section id="lifecycle">
        <h2>Story Lifecycle</h2>
        <ul>
            <li>Idea Input can be through various means such as Message, Notification, File Link, Verbal, Document.</li>
            <li>Labels Added: [Priority, Audience]</li>
            <li>Self Assign: A Team Member Self Assigns the Story</li>
        </ul>
    </section>
    <section id="types">
        <h2>Type of Stories</h2>
        <p>Product, Project, Document, Issue, Comment, Class, Page, App, Plugin, etc.</p>
    </section>
    <section id="activity">
        <h2>Story Generic Activity Flow</h2>
        <p>Steps include understanding MVI, choosing an appropriate template, elaborating story manifest, dividing your story in 5d activity stages, creating tasks for each sub-story, and more.</p>
    </section>
    <section id="templates">
        <h2>Templates</h2>
        <p>Links to templates like <a href="https://gitlab.com/bronzwik/shunya-projects/-/wikis/story-manifest-v-0-0-1">Story Manifest</a> and Generic Document Template are provided here.</p>
    </section>
</div>
...
<footer class="shunya-standard-footer" style="margin-top:24px;padding:12px 16px;border-top:1px solid #d9dfe7;background:#f8fafc;color:#334155;font:500 14px/1.5 'Segoe UI',Arial,sans-serif;text-align:center;">
  built at@shunya.ek, with own tools and bots. with leading to
  <a href="https://0dot1.live" target="_blank" rel="noopener noreferrer" style="color:#0369a1;text-decoration:none;">0dot1.live</a>
</footer>
</body>
</html>
...
## File: handbook_dot_in_action/story_of_story

```text
# Story of a Story ver 0.0.1

**Story:** A task is a story, the journey of a story passes between stages and status.

## Journey Major Milestones

- **Birth - Shunya - InQue:** The inception of an idea.
- **Process - Dot - In Development:** The development phase.
- **End - Ek - Deployed to Market:** The completion and release phase.

## **Story Lifecycle**

- **Idea Input:** Can be through various means such as:
  - Message
  - Notification
  - File Link
  - Verbal
  - Document
- **Labels Added:** [Priority, Audience]
- **Self Assign:** A Team Member Self Assigns the Story

### MVI in Story Description
- Stages in Comment.
- Approved in Files
- Deployed to a URL
...
## Story Generic Activity Flow

1. Understand MVI (Minimum Viable Input provided)
2. Choose Appropriate Template.
3. Elaborate Story Manifest in the Objective, Purpose, Story Overview, in the comment box.
4. Divide your Story in 5d Activity Stages, in the comment box.
5. Create Tasks for each sub-story, in the task box.
6. Create a Roadmap in a comment box, in the relevant folder in the current repo. Create a new branch for projects and modules.
7. Add due date.
8. Change status to InAction.
9. Add in Comments, either content or link to file.
10. Finish the story, write commit message with task ID in it.
11. Make a push.
12. Let appropriate people know.
13. Get Approvals at the end of each stage.

## Templates

- [Story Manifest](https://gitlab.com/bronzwik/shunya-projects/-/wikis/story-manifest-v-0-0-1)
...
Intro :
We build things
we take `action` on `entity`.
Story of a Story:

Status:

Each status represent a state of a story,
  often used for comparison or audit purpose.
...
Guidelines:
  - Project Repo / Branch / Folder / File Structure and naming guidelines.
  - handbook activity commit
Templates:
handbooks:
TechStack:
Cloud Resources:
  ...
  Code:
    - Gitlab
      - actorinAction : Each of you will be provided with a personal repo. All your stories should be stored in their respective branches as per the guidelines
```
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Bronzwik Docs index</title>
</head>
<body>
    <div id="bApp">
        <section>
            <header>
                <h1>Bronzwik Docs index</h1>
                <p>beaware</p>
            </header>
...
## File: story of objective and purpose

```text
# Story of Objective and Purpose: A Recursive Journey

In the quiet morning light,  
Before the world stirs from its night,  
A potter's wheel whispers tales of might,  
Of hands that shape the day, bright.

Work, a dance of dreams and reality,  
A bridge spanning over streams of duality,  
Where every drop of sweat, a pearl of vitality,  
Marks the rhythm of existence, in its totality.

In the fields, under the sun's relentless gaze,  
Farmers sow seeds of tomorrow, in today's embrace,  
Their toil, a silent prayer, woven through Earth's lace,  
A testament to hope, in nature's endless maze.

In crowded lanes, by the flicker of a dim light,  
A weaver's loom sings of colors, bold and bright,  
Each thread, a promise, binding day to night,  
A tapestry of dreams, taking flight.

Work, not just a means to an end,  
But a lover's serenade, a friend's commend,  
A child's first step, a letter sent,  
A patch on the soul, a moment spent.

For in the heart of work, lies life's true essence,  
A melody of purpose, love, and presence,  
Where every toil is a step towards transcendence,  
A journey of becoming, an eternal story of shunya.ek

---

Welcome to "shunya.ek," where each dot in our journey represents a process, a step closer to unity - to being one with success, solutions, and the end of a journey that begins with a problem. Here, we embrace the void, the "shunya," as not just a start but as a realm brimming with potential. It's where we find our challenges, our "empty," waiting to be transformed into stories of triumph.

Our narrative is crafted in stages - Discover, Design, Develop, Deploy - each a chapter that intricately weaves the fabric of our creation, our "ek." In these pages, you will find the essence of what makes us. This handbook is not merely a guide but a reflection of our collective journey. It's a testament to our process, where every story we create moves from emptiness to wholeness, from a solitary dot to a unified success.

As members of "shunya.ek," we are both the authors and characters of every story we tell. We build not just tools but bridges between problems and solutions, crafting paths that lead from the many to the one. Our work, a mosaic of dreams and reality, is a dance of creativity and logic, passion and precision.

Let this handbook serve as your compass in our world of "shunya.ek." Here, every project, product, software, and tool is a story waiting to be told, a journey from zero to one. Together, let's embark on these journeys, weaving threads of purpose, and transforming the empty into the eternal.

Welcome to our story.

```

## File: template/template_change_log
...
[Repeat the structure for each version release]


```

## File: template/template_document_generic
...
<details>
  ...
  - 1.1 Title: [Title of the Document]
  - 1.2 ID: [Unique Document Identifier]
  - 1.3 Author: [Name of the Author(s)]
  - 1.4 Last Updated: [Date]
  - 1.5 Published On: [Date]
  - 1.6 Document Activity: [Description]
  - 1.7 Document Source: [Link]
  - 1.8 Related Documents: [List]
</details>
...
<details>
  ...
  - 2.1 Audience: [Intended Audience]
  - 2.2 Objective: [Objective Description]
  - 2.3 Purpose: [Purpose Description]
  - 2.4 Scope: [Scope Description]
  - 2.5 Document Roadmap and Milestones
</details>
...
<details>
  ...
  - 3.1 Lead: [Lead Name]
  - 3.2 Associate: [Associate Name]
  - 3.3 Review: [Reviewer]
  - 3.4 Test: [Tester]
  - 3.5 Benchmark: [Benchmark]
  - 3.6 Approve: [Approver]
  - 3.7 Deploy: [Deployer]
</details>
...
<details>
  ...
  - 4.1 Document TOC: [Table of Contents]
  - 4.2 Document Guidelines: [Guidelines]
    - 4.2.1 Document Tracking: [Tracking Info]
    - 4.2.2 Document Distribution: [Distribution Info]
  - 4.3 References: [References List]
</details>


<details>
  <summary>Document Format and Structure</summary>

  - 5.1 Document Format: [Format]
  - 5.2 Document Template: [Template]
  - 5.3 Appendices: [Appendices Info]
  - 5.4 Keywords/Tags: [Keywords]
</details>


<details>
  <summary>Accessibility, Security, and Feedback</summary>

  - 6.1 Document Accessibility: [Accessibility Standards]
  - 6.2 Document Security: [Security Measures]
  - 6.3 Feedback Mechanism: [Feedback Process]
</details>
...
<details>
  ...
  - 7.2 Legal Compliance: [Compliance Info]
    - 7.2.1 Specify Legal Requirements: [Legal Requirements]
  - 7.3 Document Archiving: [Archiving Process]
  - 7.4 Contact Information: [Contact Details]
</details>
...
<details>
  ...
  - 8.1 Document Footer: [Footer Information]
  - 8.2 Document Glossary: [Glossary]
</details>

## Summary and Next Steps
- Total Word Count: 461 words
- Total Item Count: 42 items

```

## File: template/template_proposal
...
### Project Type:
[Software / Website / App / Update / Bugs / Other]
...
[Explanation of the approach and methodology to be used]
...
[Include any terms and conditions relevant to the project]
...
Please review the proposal and let us know if you have any questions or require further clarification. We are excited about the opportunity to work with you on this project.

```

## File: template/template_release_docs

```text
# Release Note - Version X.Y.Z

## Overview

[Provide a brief overview of the release, including the purpose and key highlights.]
...
[Include any additional information, such as upgrade instructions, compatibility notes, or special instructions for users.]

## Feedback

[Encourage users to provide feedback or report any issues encountered with the new release.]
...
## File: template/template_story_manifest_0-0-0

```text
# Story Manifest-v-0-0-1

## Story Meta
### Title:
*Provide the title of your story.*

### Version:
*Specify the version of the document.*

### Author:
*If the author is a human, provide [alias, email, id, name]. If AI, specify {Model && ServiceID}.*

## MVI { !NLP Task: to be Created by AI }

### Objective:
*Define the main objective of {this-story}.*

### Purpose:
*Explain the purpose behind initiating {this-story} in action.*

### Problem:
*Clearly define the problem or pain points that this product aims to address. In the future, a Sia Agent will do this process, by identifying high-value problems from User Reviews.*

## Solution
*Outline the proposed solution for addressing the identified problem.*

### Scope of Work
  - **Modules and Features:** *List the key modules and features of the solution.*
  - **Actors:** *Define the roles of actors interacting with the system.*
  - **Actions:** *Specify the actions that can be performed by the actors.*
  - **User Flow and User Stories:** *Describe user interactions and narratives.*
  - **Services:** *Detail the services provided by the solution.*
  - **Dataset:** *Mention any relevant datasets used in the solution.*

### Current World: {{!rework: this section }}
* **Type of Project:** *Describe the nature of the project (e.g., research, development, application).*
* **Technique Strategy:** *Outline the methodologies and strategies that are being used.*
* **Existing Projects/Products:** *Research and list existing projects or products that are similar or relevant.*
* **Competition:** *Identify and analyze potential competitors in the market.*
* **Inspiration:** *Discuss any inspirations or benchmarks for the project.*
* **Tutorials:** *List resources and tutorials that might be helpful for the project.*
* **Common Features In Project:** *Identify features commonly found in similar projects.*

### Tech Specs
  - **Pipeline:** *Describe the data or process flow within the solution.*
  - **Architecture:** *Explain the overall architecture of the solution.*
  - **Techniques:** *Highlight the techniques or technologies used.*
  - **Classes and Methods:** *Provide insights into code structure.*
  - **Database:** *Describe the database schema and design.*
  - **User Interface:** *Explain the UI components and design principles.*

### User Docs
- **How to Install:** *Provide instructions on how to install the product.*
- **How to Test:** *Explain the testing procedures and guidelines.*
- **How to Use:** *Offer guidance on using the product effectively.*

## Roadmap
*Outline the future plans and milestones for the product.*

## Activity
*Record the activities and progress during the product discovery phase.*

## Team
*List the members of the product discovery team and their roles.*

## Resources
*List the resources to create and maintain this project.*

## Scope of Work
*Outline the boundaries and deliverables of the project.*

## Work Effort Breakdown
*Break down the project into smaller tasks and estimate the effort required for each.*
