/*
========================================================
ActionValidator Utility v1.0.0
========================================================

Purpose
--------------------------------------------------------
Schema-first validation harness for ehh-v-104. Ensures
config-driven property, array, patternProperties, enum,
format, constraint, and type rules run consistently across
runtimes. Integrates RBAC/ABAC helpers, nested rule
evaluation, and debug utilities while respecting
dataset_instructions_coding conventions (imports-only,
object exports, explicit comments).

Key Capabilities
--------------------------------------------------------
- Property validation (required/type/enum/constraint/pattern)
- Recursive nested object/array evaluation even without
  explicit validate blocks
- JSON Schema patternProperties support
- Constraint-driven rule/evaluator engine (and/or/not/condition)
- RBAC and attribute-level policy checks
- Validation summaries + debug trace helpers
- Format validators (date, email, URL, uuid)
========================================================
*/
export const ACTION_VALIDATOR_VERSION = "1.0.0";
...
console.log(`✅ ActionValidator v${ACTION_VALIDATOR_VERSION} Loaded (schema-first, dataset-informed)`);
