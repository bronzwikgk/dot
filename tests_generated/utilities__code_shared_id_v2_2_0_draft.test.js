// AUTOGENERATED by pipeline system_validate_and_test_code_shared_v2 for code_shared_id_v2_2_0_draft
// regenerate instead of editing
const test = require("node:test");
const assert = require("node:assert");
const fs = require("node:fs");
const path = require("node:path");
const mod = require("E:\\root_0dot1_wip\\shared_v2\\code\\utilities\\code_shared_id_v2_2_0_draft.js");
const SNAPSHOT_DIR = __dirname;
const SNAPSHOT_PATH = path.join(SNAPSHOT_DIR, "snapshots/utilities__code_shared_id_v2_2_0_draft.snap.json");
...
test("new_id [edge_safety] edge_0", () => {
  const __args = [];
  try {
    __call("new_id", __args);
  } catch (error) {
